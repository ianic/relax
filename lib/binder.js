...
relax.uiBinder.BinderBase = function(element, object, property){
  ...
  this.onBlur = function(){  
    //console.log("binder[" + this.property + "] - onBlur"); 
		this.model[this.property] = this.elementValue();
		this.model.changed();
    
/*    if (typeof this.model[property] == "number")
      this.model[property] = parseFloat(this.element.value);
    else
      this.model[property] = this.element.value;
      
    if (this.model[property + 'Changed'] != null)
      this.model[property + 'Changed']();
    else
      this.model.changed();
*/  }                       
  
  this.onChanged = function(){
    //console.log("binder[" + this.property + "] - onChanged");
